# Code Smells and Refactoring Examples in Java

A comprehensive collection of Java examples demonstrating **code smells** (anti-patterns) and their corresponding **refactoring solutions**. This project serves as a practical guide for developers to recognize problematic code patterns and apply appropriate refactoring techniques in Java.

## 📚 What You'll Learn

- **Identify Code Smells**: Learn to recognize 10 common code anti-patterns
- **Apply Refactoring Techniques**: Master refactoring methods adapted for Java
- **See Real Examples**: Before/after code comparisons in Java
- **Understand Best Practices**: Learn maintainable, clean Java code principles
...
│   ├── 01-extract-method.java     # Extract Method refactoring
│   ├── 02-variable-refactoring.java # Variable refactoring techniques
│   ├── 03-moving-features.java    # Moving methods and fields
│   ├── 04-data-organization.java  # Data restructuring
│   ├── 05-conditional-expressions.java # Simplifying conditionals
│   ├── 06-method-calls.java       # Method signature improvements
│   ├── 07-generalization-problems.java # Inheritance issues
│   └── 08-major-refactorings.java # Large-scale refactorings
...
Comprehensive examples of **refactoring techniques** adapted for Java from Martin Fowler's book:
...
cd java/code-duplication/bad
javac *.java
java -cp . OrderProcessor
...
3. **Practice** - Apply techniques to your own Java code
...
- **Recognize** problematic code patterns in Java quickly
- **Apply** appropriate refactoring techniques confidently in Java
- **Write** cleaner, more maintainable Java code
- **Understand** the principles behind clean code in Java
- **Refactor** legacy Java code safely and effectively

## 🤝 Contributing

Found a bug or want to add more Java examples?
