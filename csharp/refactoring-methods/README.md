# C# Refactoring Methods Examples

This directory contains C# examples for the refactoring techniques described in Martin Fowler's book "Refactoring: Improving the Design of Existing Code".

## Structure

The refactoring techniques are organized into 8 files based on categories:

### 01-extract-method.cs
...
Each file contains C# classes demonstrating the "before" and "after" states of refactoring. The "before" examples show code that could benefit from refactoring, while the "after" examples show the improved code structure.

You can compile and run these examples using the .NET CLI:

```bash
dotnet build
dotnet run --project 01-extract-method.csproj
```

Or using Visual Studio or any C# IDE.
